...
def main(options, args):
        ...
        f_mutrig_BCDEF = rt.TFile.Open(os.path.expandvars("$ZPRIMEPLUSJET_BASE/analysis/ggH/EfficienciesAndSF_RunBtoF_Nov17Nov2017.root"), "read")
        mutrig_eff = f_mutrig_BCDEF.Get("Mu50_PtEtaBins/efficienciesDATA/pt_abseta_DATA")
        mutrig_eff.Sumw2()
        ...
        tag2.SetTextSize(0.042); tag3.SetTextSize(0.033);
        tag1.Draw(); tag2.Draw(); tag3.Draw()        
        d.Print('mutrig_eff_2017.pdf') 

        f_muid_BCDEF = rt.TFile.Open("$ZPRIMEPLUSJET_BASE/analysis/ggH/Muon2017_RunBCDEF_SF_ID.root", "read")
        muid_eff = f_muid_BCDEF.Get(
        ...
        tag2.SetTextSize(0.042); tag3.SetTextSize(0.033);
        tag1.Draw(); tag2.Draw(); tag3.Draw()
        d.Print('muid_eff_2017.pdf')

        
        f_muiso_BCDEF = rt.TFile.Open("$ZPRIMEPLUSJET_BASE/analysis/ggH/Muon2017_RunBCDEF_SF_ISO.root", "read")
        muiso_eff = f_muiso_BCDEF.Get("NUM_LooseRelIso_DEN_LooseID_pt_abseta")
        muiso_eff.Sumw2()
