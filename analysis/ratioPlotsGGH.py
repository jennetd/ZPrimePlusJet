...
def main(options,args,outputExists):
    ...
    #idir = options.idir
    idir = '/eos/uscms/store/user/lpcbacon/dazsle/zprimebits-v15.01/skim/'
    odir = options.odir
    lumi = options.lumi
    ...
    if not outputExists: 
        print "Backgrounds..."
        bkgSamples = {}    
        bkgSamples['QCD'] = normSampleContainer('QCD', tfiles['QCD'], 1, DBTMIN,lumi, False, False, '1', False, iSplit = options.iSplit, maxSplit = options.maxSplit,puOpt="default",doublebName=options.doublebName, doublebCut = options.doublebCut).addPlots(plots)
